...
namespace FargowiltasCrossmod.Content.Calamity.UI
{
    ...
    public class InfernumNotification : IInGameNotification
    {
        ...
        private Asset<Texture2D> iconTexture = ModContent.Request<Texture2D>("FargowiltasSouls/icon_small");
        ...
        public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
        {
            ...
            string title = Language.GetTextValue("Mods.FargowiltasCrossmod.UI.WarningInfernum");
